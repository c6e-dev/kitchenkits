  ...
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">
      <div class="nav" role="tablist">
        <button type="button" class="btn btn-sm bg-purple btn-flat" style="margin: 0px 5px 10px 0px" data-toggle="modal" data-target="#add_recipe" data-backdrop="static"><i class="fa fa-plus-circle"></i></button>
