  ...
  <script>
    $(function(){
      ...
      $.ajax({
        url: "<?php echo site_url('customer/notify_me'); ?>",
        dataType : 'json',
        success: function(data){
          ...
          if (count==null) {
            ...
            for(var i=0; i<count; i++){
              notif += '<li><a href="<?php echo site_url(); ?>customer/confirm_latest_order'+'?id='+data[i].od_id+'"><div class="pull-left"><img src="<?php echo base_url('assets/dist/img/notifbell.png');?>" class="img-circle" alt="User Image"></div><h4>'+data[i].od_code+'<small><i class="fa fa-clock-o"></i> '+data[i].ua_cd+'</small></h4><p>Confirm This Order</p></a>'+'</li>';
            }
            $('.menu').html(notif);
          }
        },
