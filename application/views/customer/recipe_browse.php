              ...
              foreach ($recipe as $rcp) {
                ?>
                  <div class="card border-dark">
                    <a href="<?php echo site_url('customer/view_recipe'.'?id='.$rcp->re_id); ?>"><img class="card-img-top" src="<?php echo base_url('Recipe_Folder/'.$rcp->re_name.'/'.$rcp->re_img); ?>" height="350px"></a>
                    <div class="card-body">
